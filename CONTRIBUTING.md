...
Preserve original PDFs, model files, and the archive. Work on a separate branch and submit focused changes. Update documentation and regenerate `SHA256SUMS.txt` when distributed files change. The manifest covers all distributed files except itself.
